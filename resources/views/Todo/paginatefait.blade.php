    ...
    <div class="container mt-5">
        @if ($todofait->isEmpty())
            <div class="alert alert-info text-center">
                <h4 class="alert-heading">Pas de tâches</h4>
                    ...
                    <div class="col-md-8">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <p><strong>Jour à faire :</strong> {{ \Carbon\Carbon::parse($tache->jour_a_faire)->format('d/m/Y') }}</p>
                                <p><strong>Jour de création :</strong> {{ \Carbon\Carbon::parse($tache->created_at)->format('d/m/Y H:i') }}</p>
                                <p><strong>Dernière modification :</strong> {{ \Carbon\Carbon::parse($tache->updated_at)->format('d/m/Y H:i') }}</p>
